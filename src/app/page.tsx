...
export default function Home() {
  return (
    <MainLayout>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-background to-accent-gold/5 py-20 md:py-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              <h1 className="font-heading text-4xl md:text-6xl font-bold tracking-tight text-text-primary mb-6">
                ...
                <span className="text-accent-gold">with Premium Hair</span>
              </h1>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-accent-gold text-white p-4 rounded-lg shadow-lg md:max-w-[200px]">
                <p className="font-heading text-lg">100% Human Hair</p>
                <p className="text-sm mt-1">Premium quality, ethically sourced</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="relative overflow-hidden rounded-lg group">
              <div className="aspect-[4/5] bg-accent-gold/10">
                <div className="absolute inset-0 bg-accent-gold/10"></div>
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1601497211164-8e89df0e8b9c?q=80&w=800&auto=format&fit=crop"
                  alt="Hair Extensions"
                  fill
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-t from-black/60 to-transparent p-6 text-center">
                <h3 className="font-heading text-2xl font-bold text-white mb-4">Hair Extensions</h3>
                <Button variant="outline" className="bg-white/80 border-white text-text-primary hover:bg-white">
            ...
            <div className="relative overflow-hidden rounded-lg group">
              <div className="aspect-[4/5] bg-accent-gold/10">
                <div className="absolute inset-0 bg-accent-gold/10"></div>
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1563539858-f9516e1e4dc4?q=80&w=800&auto=format&fit=crop"
                  alt="Wigs"
                  fill
                  className="object-cover transition-transform duration-500 group-hover:scale-105"
                  fallbackType="cover"
            ...
            <div className="relative overflow-hidden rounded-lg group">
              <div className="aspect-[4/5] bg-accent-gold/10">
                <div className="absolute inset-0 bg-accent-gold/10"></div>
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?q=80&w=800&auto=format&fit=crop"
                  alt="Hair Care"
                  fill
                  className="object-cover transition-transform duration-500 group-hover:scale-105"
                  fallbackType="cover"
